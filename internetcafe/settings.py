"""
Django settings for internetcafe project.
...
SECRET_KEY = 'django-insecure-i+c23(4h08taykfrggez+(abay-@jf%d5(gofnqiyb%490*=%0'
...
ROOT_URLCONF = 'internetcafe.urls'
...
WSGI_APPLICATION = 'internetcafe.wsgi.application'
